...
fun verifyQQbot(sender: Member):Boolean{
    return (sender.nameCard == "Q群管家" || sender.id == 2854196310)
}
                ...
                for (sc in seachers) {
                    ...
                    if (allp > config.MaxBorder) {
                        ...
                        if(config.notification!!)
                            this.group.owner.sendMessage(MiraiCode.deserializeMiraiCode("[QQ群${this.group.id}]撤回违规信息[${this.message.serializeToMiraiCode()}]来自群成员[${this.sender.id}]"))
